...
class Booking(models.Model):
    ...
    flight = models.ForeignKey('Flight', models.DO_NOTHING, db_column='flight_ID', blank=True, null=True)  # Field name made lowercase.
...
class Flight(models.Model):
    ...
    plane = models.ForeignKey('Plane', models.DO_NOTHING, db_column='plane_ID', blank=True, null=True)  # Field name made lowercase.
